(function () {
    ...
    const BUTTON_ID = 'chesscom-to-lichess-analysis-button';
    const REVIEW_BUTTON_ID = 'chesscom-to-lichess-analysis-review-button';
    const MESSAGE_ID = 'chesscom-to-lichess-analysis-message';
    ...
    new MutationObserver(schedulePageButtonSync).observe(
